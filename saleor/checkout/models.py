...
class Checkout(ModelWithMetadata):
    ...
    def get_total_weight(self):
        ...
        weights = zero_weight()
        for line in self:
            weights += line.variant.get_weight() * int(line.quantity)
        return weights
...
class CheckoutLine(models.Model):
    ...
    #quantity = models.DecimalField(validators=[MinValueValidator(1)])
    quantity = models.DecimalField(max_digits=12,decimal_places=2,validators=[MinValueValidator(1)])
